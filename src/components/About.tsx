          ...
          <div className="space-y-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="relative">
                <div className="w-full h-96 bg-gradient-to-br from-[#292B87] to-[#0090D1] rounded-3xl shadow-2xl flex items-center justify-center">
                  <span className="text-white text-xl font-semibold" style={{ fontFamily: 'Open Sans, sans-serif' }}>
            ...
            <div className="bg-white rounded-3xl p-12 shadow-lg">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                <div className="space-y-6">
                  <h3 className="text-2xl font-bold text-[#292B87]" style={{ fontFamily: 'Montserrat, sans-serif' }}>
              ...
              {personalInfo.map((item, index) => (
                <div key={index} className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <div className="flex flex-col items-center text-center">
                    <div className="w-16 h-16 bg-gradient-to-r from-[#292B87] to-[#0090D1] rounded-2xl flex items-center justify-center mb-6">
                    ...
                    <div key={index} className="relative flex md:min-h-[150px]">
                      ...
                      {index % 2 === 0 ? (
                        <div className="w-full md:w-1/2 md:pl-[80px] md:pr-0 flex flex-col items-start md:items-end">
                          <div className="bg-[#F7F7F7] p-6 rounded-xl shadow-lg border-l-4 border-[#0090D1] max-w-md text-left md:text-right">
                        ...
                        <div className="w-full md:w-1/2 md:pr-[80px] md:pl-0 flex flex-col items-end md:items-start ml-auto">
                          <div className="bg-[#F7F7F7] p-6 rounded-xl shadow-lg border-r-4 border-[#0090D1] max-w-md text-left">
                            <div className="text-sm font-bold text-[#0090D1] mb-2" style={{ fontFamily: 'Montserrat, sans-serif' }}>{item.year}</div>
                            <h4 className="text-xl font-bold text-[#292B87] mb-3" style={{ fontFamily: 'Montserrat, sans-serif' }}>{item.title}</h4>
                            <p className="text-[#1C1C1C] leading-relaxed" style={{ fontFamily: 'Open Sans, sans-serif' }}>{item.description}</p>
                          </div>
            ...
            <div className="bg-gradient-to-r from-[#292B87] to-[#0090D1] rounded-3xl p-12 text-white text-center">
              <Heart className="w-16 h-16 mx-auto mb-8 text-white" />
              ...
              <p className="text-xl leading-relaxed max-w-4xl mx-auto" style={{ fontFamily: 'Open Sans, sans-serif' }}>
                {language === 'fr' 
            ...
            <div className="bg-white rounded-3xl p-12 shadow-lg">
              <div className="text-center mb-12">
                <h3 className="text-3xl md:text-4xl font-bold text-[#292B87] mb-6" style={{ fontFamily: 'Montserrat, sans-serif' }}>
              ...
              {/* Cheffe du parti */}
              <div className="mb-12">
                <h4 className="text-2xl font-bold text-[#292B87] mb-8 text-center" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                  {language === 'fr' ? 'Leadership' : 'Leadership'}
                </h4>
                <div className="flex justify-center">
                  <div className="bg-gradient-to-r from-[#292B87] to-[#0090D1] p-8 rounded-2xl text-white max-w-md text-center">
              ...
              <div className="mb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {[
                    ...
                    <div key={index} className="bg-[#F7F7F7] p-6 rounded-xl text-center hover:shadow-lg transition-shadow duration-300">
                      <div className="w-20 h-20 rounded-full overflow-hidden border-3 border-[#292B87] mx-auto mb-4">
                        <img 
                          src={member.image} 
                          alt={member.name}
                          className="w-full h-full object-cover"
                      ...
                      <h5 className="text-lg font-bold text-[#292B87] mb-2" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                        {member.name}
                      </h5>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
                  {[
                    ...
                    <div key={index} className="text-center">
                      <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-[#292B87] mx-auto mb-3">
                        <img 
                          src={member.image} 
                          alt={member.name}
                          className="w-full h-full object-cover"
                      ...
                      <h5 className="text-sm font-bold text-[#292B87] mb-1" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                        {member.name}
                      </h5>
